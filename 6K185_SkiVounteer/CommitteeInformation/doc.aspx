<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="doc.aspx.vb" Inherits="CommitteeInformation_doc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <center>
    <iframe src=<%=BodyDoc%> width="810px" height="600px" scrolling="auto" frameborder="1"></iframe>
    </center>
    <br />
