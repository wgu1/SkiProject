<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="Video" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <center>
    <iframe src=<%=IntroDoc%> width="810px" height="600px" scrolling="auto" frameborder="1"></iframe>
    </center>
    </div>
