...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="adminholder">
    <asp:Label ID="CommitteeLabel" runat="server" ForeColor="BurlyWood" Text="Please select a committe to modify: "></asp:Label>   
    ...
    <br />
    <asp:Label ID="videoLabel" runat="server" ForeColor="BurlyWood" Text="Enter URL to Youtube video:"></asp:Label>
    <br />
    <asp:TextBox ID="videoTextBox" runat="server" Width="300px"></asp:TextBox>
    <asp:Button ID="videoButton" runat="server" Text="Upload" />
    <br />
    <asp:Label ID="videoResultLabel" runat="server" ForeColor="BurlyWood" Text=""></asp:Label>
    <br />
    <br />
    ...
    <br />
    <asp:Label ID="documentLabel" runat="server" ForeColor="BurlyWood" Text="Please upload a new document:"></asp:Label>
    <br />
    <asp:FileUpload ID="documentUpload" runat="server" Width="200px" />
    <asp:Button ID="documentButton" runat="server" Text="Upload" />
    <br />
    <asp:Label ID="documentResultLabel" runat="server" ForeColor="BurlyWood" Text=""></asp:Label>
    </div>
</asp:Content>
